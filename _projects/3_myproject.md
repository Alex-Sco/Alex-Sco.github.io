...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/CN_hyperfine_anomaly_illustration.png" title="Galactic carbon isotope ratio gradient" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
